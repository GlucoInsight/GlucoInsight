...
class GlucoseService {
    private let url1 = URL(string: "http://glucoinsight.simolark.com:8080/gluco?user_id=1")!
    private let url2 = URL(string: "http://glucoinsight.simolark.com:8080/gluco?user_id=2")!
    ...
    func fetchGlucoseData2(completion: @escaping ([GlucoseReading]?) -> Void) {
